...
setup(
  ...
  entry_points = { 'desktop.sdk.application': 'patients=patients' },
  zip_safe = False,
  package_data = {
    # Include static resources.  Package_data doesn't
    # deal well with directory globs, so we enumerate
    # the files manually.
    'patients': expand_package_data(
      ["src/patients/templates", "src/patients/static", "src/patients/static/patients.css", "src/patients/static/css/patients.css"],
      "src/patients/")
  }
)
